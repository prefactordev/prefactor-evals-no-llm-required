...
```
{
  ...
  "instance_over": true,
  "slowest_spans": [
    { "span_id": "01kxye3p2m7synth88k1v5t7n2ra94xc", "name": "generate_report", "type": "tool_call", "duration_ms": 41220 }
  ],
  "over_span_count": 1,
  "measured_spans": 43,
  "unmeasured_spans": 2,
  "unmeasured_span_ids": ["01kxye7r1p7synth44m2d8s6j3vc90xk", "01kxye7r1p7synth51n8e2t7l4wd21ym"]
}
```
